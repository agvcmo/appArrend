...
namespace GestionArriendo.Controllers
{
    public class ArchivosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Ruta,Tipo,Fecha,Descripcion")] Archivo archivo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Ruta,Tipo,Fecha,Descripcion")] Archivo archivo)
        {
            if (ModelState.IsValid)
            {
